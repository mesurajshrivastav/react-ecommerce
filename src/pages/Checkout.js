      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
          <div className="lg:col-span-3">
            <form className="bg-white p-5 mt-12">
              <div className="border-b border-gray-900/10 pb-12">
                <h2 className="text-xl py-10 font-semibold text-gray-900">
              ...
              <div className="border-b border-gray-900/10 pb-12">
                ...
                <ul role="list" className=" divide-gray-100">
                  {addresses.map((address) => (
                    <li
                      key={address.email}
                      className="flex justify-between border-2 gap-x-6 py-5 border-solid  px-5 border-gray-200"
                    >
                ...
                <div className="mt-10 space-y-10">
                  <fieldset>
                    ...
                    <p className="mt-1 text-sm/6 text-gray-600">Select one</p>
          ...
          <div className="lg:col-span-2">
            <div className="border mx-auto mt-12 bg-white max-w-7xl px-0 sm:px-0 lg:px-0">
